...
<body class="main-bg">
        <div class="login-container text-c animated flipInX">
                <div>
                    ...
                    <h3 class="text-whitesmoke p-4"><strong>Admin Panel</strong></h3>
                <div class="container-content">
                    <form class="margin-t" method="post" action="<?php echo url('saveData')?>">
                    @csrf
                    ...
                    <p class="margin-t text-whitesmoke"><small> @Copyright &copy; <?php echo date('Y')?></small> </p>
                </div>
            </div>
</body>
</html>
